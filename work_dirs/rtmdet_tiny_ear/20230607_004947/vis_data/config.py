...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=('ear', )),
        ann_file=
        'MMPosehomework/Ear210_Dataset_coco/Ear210_Keypoint_Dataset_coco/train_coco.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    'MMPosehomework/Ear210_Dataset_coco/Ear210_Keypoint_Dataset_coco/MMPosehomework/Ear210_Dataset_coco/Ear210_Keypoint_Dataset_coco/val_coco.json',
    metric=['bbox'],
    format_only=False,
    backend_args=None,
